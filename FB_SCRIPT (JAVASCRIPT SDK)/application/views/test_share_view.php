	...
	<script src="http://ads.lfstmedia.com/getad?site=269927" type="text/javascript"></script>
</head>
<body>
		<div id="fb-root"></div>
...
<div class="main">
	...
	<?php 
		...
		$cover_pic = $app_data = $app_name = $app_names = $ad_top = $m_top = $m_bottom = $ad_right_two = $ad_right = '';
		$i =0; $c =-1;
	...
	?>
	<script type="text/javascript">
		var start_quiz_url = '<?php echo site_url('create'); ?>';
		...
		var result_url = '<?php echo site_url('result').'/'.$id.'/test/'; ?>';
	</script>
