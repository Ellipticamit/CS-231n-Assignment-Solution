		...
		<section class="vbox"> 
			<section class="scrollable padder"> 
				<ul class="breadcrumb no-border no-radius b-b b-light pull-in"> 
					...
					<li><a href="<?php echo site_url('admin/friend/friend_pic_details').'/'.$appid; ?>">
						<i class="fa fa-home"></i> Friend Profile Pic Details</a></li>
					<li class="active">Edit Friend Profile Pic Details</li>						
				</ul>
				<section class="panel panel-default"> 
					<header class="panel-heading font-bold">Edit Friend FB Pic </header> 
				...
				<?php	
					...
					echo form_open('admin/friend/edit_friend_pic/'.$id, $attributes); 
				?>
							...
							<div class="col-md-4 form-group" style="padding:0px 0px 0px 0px;"> 								
