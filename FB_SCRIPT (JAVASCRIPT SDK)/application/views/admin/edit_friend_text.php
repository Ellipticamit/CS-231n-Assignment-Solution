<?php
	$size = $font = $color = $capson =  $full_name = $text_x = $text_y = $length = $appid = $app_text = $options = $appid = '';
	if(!empty($text_query)) {
	...
	if($full_name == 'yes') { $checked_fullname = 'checked'; }
?>		
	<section id="content">
		<section class="vbox"> 
			<section class="scrollable padder"> 
				<ul class="breadcrumb no-border no-radius b-b b-light pull-in"> 
					...
					<li><a href="<?php echo site_url('admin/friend/friend_text/'.$appid);?>"><i class="fa fa-home"></i>&nbsp; Friend Name Details</a> </li>
					<li class="active">Edit Friend Name Text </li>						
				</ul>
				...
				<?php	
					...
					echo form_open('admin/friend/edit_friend_text/'.$id, $attributes); 
				?>
							...
							<div class="form-group col-md-4" style="padding:0px 10px 0px 10px;"> 
						    ...
						    <div class="form-group col-md-4" style="padding:0px 10px 0px 0px;"> 
								...
								<div class="checkbox" style="margin-top:0px;"> <label> 
									<input type="checkbox" value="yes" name="full_name" <?php echo $checked_fullname;?>> Yes  </label> 
								</div>
						    </div>
