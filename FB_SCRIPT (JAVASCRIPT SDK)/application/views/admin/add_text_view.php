	...
	if(!empty($text_query)) {
		foreach($text_query as $row) {
			$text_data .= '<tr>
							...
							<td>'.$row->text_y.'</td>
							<td>'.$row->options.'</td>
							<td><a href="'.site_url('admin/app/edit_text/').'/'.$row->tid.'" class="btn btn-xs btn-primary">Edit</a> &nbsp;
								<a href="'.site_url('admin/app/delete_text/').'/'.$row->tid.'_'.$row->appid.'" class="btn btn-xs btn-danger">Delete</a></td>
						  </tr>';;
			$i++;
		}
	}
		...
		<section class="vbox"> 
			<section class="scrollable padder"> 
				...
				<?php	
					...
					echo form_open_multipart('admin/app/add_text/'.$id, $attributes); 
				?>
