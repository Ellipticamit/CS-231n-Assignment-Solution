	...
	if(!empty($user_pic_query)) {		
		foreach($user_pic_query as $row) {		
			$user_data .= '<tr>						
								...
								<td>'.$row->img_shape.'</td>	
								<td><a href="'.site_url('admin/app/edit_user_pic/').'/'.$row->fuid.'" class="btn btn-xs btn-primary">Edit</a> &nbsp; <a href="'.site_url('admin/app/delete_user_pic/').'/'.$row->fuid.'_'.$row->appid.'" class="btn btn-xs btn-danger">Delete</a></td>		
								</tr>';			
								$i++;		
		}	
	}
		...
		<section class="vbox"> 			
			<section class="scrollable padder"> 			
				<ul class="breadcrumb no-border no-radius b-b b-light pull-in"> 	
					...
					<li class="active">Add Final Background Pic</li>
				</ul>	
				<section class="panel panel-default"> 		
					<header class="panel-heading font-bold">FB User Pic Form</header> 					
						<div class="panel-body"> 		
							<?php					
								...
								if(!empty($success)) { 		
								 ...
								 echo form_open('admin/app/profile_pic_details/'.$id, $attributes);
							?>		
						...
						<?php if(!empty($user_data)) { ?>					
							<section class="panel panel-default"> 					
								<header class="panel-heading font-bold">Added Background Pic Details</header>					
								<div class="panel-body">						
