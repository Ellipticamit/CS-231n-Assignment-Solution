		...
		<section class="vbox"> 
			<section class="scrollable padder"> 
				<ul class="breadcrumb no-border no-radius b-b b-light pull-in"> 
					...
					<li><a href="<?php echo site_url('admin/app/add_text/'.$appid);?>"><i class="fa fa-home"></i>&nbsp; Add Text</a> </li>
				...
				<?php	
					...
					echo form_open('admin/app/edit_text/'.$id, $attributes); 
				?>
						    ...
						    <div class="form-group col-md-4" style="padding:0px 0px 0px 0px;"> 
